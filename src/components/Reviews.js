        ...
        <div className="padding-section-medium">
          ...
          <div data-delay="4000" data-animation="slide" className="ratings-reviews_component w-slider" data-autoplay="true" data-easing="ease" data-hide-arrows="false" data-disable-swipe="false" data-autoplay-limit="0" data-nav-spacing="3" data-duration="500" data-infinite="true" fs-cmsslider-element="slider-1" role="region" aria-label="carousel">
            <div className="ratings-reviews_mask w-slider-mask" id="w-slider-mask-0">
              <div className="ratings-reviews_slide w-slide" aria-label="1 of 3" role="group" style={{transition: "all, transform 500ms", transform: "translateX(-1138.21px); opacity: 1;"}} aria-hidden="true">
                <div className="ratings-reviews_content" aria-hidden="true">
                  ...
                  <div className="margin-vertical margin-medium" aria-hidden="true">
                    <div className="text-size-medium text-weight-bold" aria-hidden="true">"I had a gate safety issue and needed it addressed immediately. I called a garage door supplier who specializes in gate safety checks and they were able to quickly diagnose and fix the issue. They also provided me with tips on how to maintain gate safety in the future. I appreciate their attention to safety and their excellent customer service."</div>
                  </div>
                  <div className="ratings-reviews_client" aria-hidden="true">
                    <div className="ratings-reviews_client-info" aria-hidden="true">
                      <p className="text-weight-semibold" aria-hidden="true">Yohanna M.</p>
                    </div>
                  </div>
                </div>
              </div>
              <div className="ratings-reviews_slide w-slide" aria-label="2 of 3" role="group" style={{transition: "all, transform 500ms", transform: "translateX(-1138.21px); opacity: 1;"}}>
                <div className="ratings-reviews_content">
                  ...
                  <div className="margin-vertical margin-medium">
                    <div className="text-size-medium text-weight-bold text-color-white">
                      <strong>"I decided to give it a try, and I am glad I did. The company is easy to use, the prices are reasonable, and the end results are fantastic. I am so happy that I decided to go this route."</strong>
                    </div>
                  </div>
                  <div className="ratings-reviews_client">
                    <div className="ratings-reviews_client-info">
                      <p className="text-weight-semibold">Carson W.</p>
                    </div>
                  </div>
                </div>
              </div>
              <div className="ratings-reviews_slide w-slide"  role="group" style={{transition: "all, transform 500ms", transform: "translateX(-1138.21px); opacity: 1;"}} aria-hidden="true">
                <div className="ratings-reviews_content" aria-hidden="true">
                  <div className="stars_rating-wrapper" aria-hidden="true">
                    <div className="stars_rating-icon text-color-accent w-embed" aria-hidden="true">
                      <svg width="100%" viewBox="0 0 18 17" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                  ...
                  <div className="margin-vertical margin-medium" aria-hidden="true">
                    <div className="text-size-medium text-weight-bold text-color-white">
                      <strong aria-hidden="true">"After replacing a garage door spring on my own I ran into an issue with the door not hanging correctly. I contacted Anytime Garage Doors repair first thing in the morning and by about 10 am they had a great technician at my house. He gave me a quote for what needed to be replaced and got me fixed up very quickly. &nbsp;I highly recommend."</strong>
                    </div>
                  </div>
                  <div className="ratings-reviews_client">
                    <div className="ratings-reviews_client-info" aria-hidden="true">
                      <p className="text-weight-semibold" aria-hidden="true">Marion E.</p>
                    </div>
                  </div>
                </div>
              </div>
