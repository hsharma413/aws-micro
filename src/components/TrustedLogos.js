   ...
   <section className="section_logo">
     <div className="container-large">
       <div className="padding-large">
         ...
         <img sizes="(max-width: 700px) 100vw, 700px" loading="lazy" id="w-node-_833942f8-6514-a88b-6d83-900abe2b5e38-be2b5e2e" src="/assets/images/facebook_5stars.png" alt="" class="trust-logo_logo" />
         <img loading="lazy" sizes="(max-width: 767px) 100vw, (max-width: 810px) 95vw, 770px" src="/assets/images/facebook_5stars.png" alt="" class="trust-logo_logo" />
